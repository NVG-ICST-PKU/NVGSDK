...
static const AVOption movie_options[]= {
	...
	{"flag_zhd", NULL, OFFSET(flag_zhd), AV_OPT_TYPE_STRING, {.str =  0}, CHAR_MAX, CHAR_MAX, FLAGS},
	{ NULL },
};
...
//#include "libavfilter/avfilter.c"
//#define MKTAG(a,b,c,d) ((a) | ((b) << 8) | ((c) << 16) | ((unsigned)(d) << 24))
//#define FFERRTAG(a, b, c, d) (-(int)MKTAG(a, b, c, d))
//#define FFERROR_NOT_READY FFERRTAG('N','R','D','Y')
//#define FF_INTERNAL_FIELDS 1
static int activate_zhd(AVFilterContext *filter)
{
	AVFilterLink *link = filter->outputs[0];
	MovieContext *c = filter->priv;

	int ret = -1;
	av_opt_set(c->format_ctx->priv_data, "orientation", c->flag_zhd, 0);
